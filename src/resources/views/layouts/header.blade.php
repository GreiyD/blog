<header class="fixed-top">
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand" href="{{route('home.index')}}">MyBlog</a>
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    @guest
                        <li class="nav-item">
                            <a class="nav-link {{ request()->is('login') ? 'active font-weight-bold' : '' }}" href="{{route('login.form')}}">Login</a>
                        </li>
                    @else
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                                <li><a class="dropdown-item" href="{{route('profile.show', $user->profile->id)}}">Profile</a></li>
